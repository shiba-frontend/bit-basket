...
const AddSme = () => {
     ...
     const [stateList, setstateList] = useState([])
      ...
      const [selectedOption1, setSelectedOption1] = useState("UAE");
    ...
    <div className='dashboard-panel'>
        ...
        <div className='container-fluid'>
            ...
            <div className='right-comon'>
                <h3 className='page-title'>Add SME</h3>
         ...
         <div className='form-group'>
             ...
             <div className='d-flex'>
                 ...
                 <input className="form-check-input" type="radio" name="flexRadioDefault1" id="flexRadioDefault22" 
                 value="USA"
                 checked={selectedOption1 === "USA"}
                 onChange={handleRadioChange1}
                 />
